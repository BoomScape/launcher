...
OutputBaseFilename=BoomPSTestServer32

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${project.projectDir}\build\win-x86\BoomPSTestServer.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-x86\BoomPSTestServer.jar"; DestDir: "{app}"
