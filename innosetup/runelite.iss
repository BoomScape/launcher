...
OutputDir=${basedir}
OutputBaseFilename=BoomScapeTestServerSetup

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-x64\BoomScapeTestServer.exe"; DestDir: "{app}"
Source: "${basedir}\build\win-x64\BoomScapeTestServer.jar"; DestDir: "{app}"
