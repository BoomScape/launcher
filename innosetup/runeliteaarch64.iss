...
[Files]
Source: "${project.projectDir}\build\win-aarch64\BoomPS.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-aarch64\BoomPS.jar"; DestDir: "{app}"
