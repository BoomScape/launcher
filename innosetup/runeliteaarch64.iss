...
OutputBaseFilename=BoomPSTestServerAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${project.projectDir}\build\win-aarch64\BoomPSTestServer.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-aarch64\BoomPSTestServer.jar"; DestDir: "{app}"
