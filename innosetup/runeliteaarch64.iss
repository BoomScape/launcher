...
OutputDir=${basedir}
OutputBaseFilename=BoomScapeTestServerSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\BoomScapeTestServer.exe"; DestDir: "{app}"
Source: "${basedir}\build\win-aarch64\BoomScapeTestServer.jar"; DestDir: "{app}"
