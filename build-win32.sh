...
cp native/build-x86/src/Release/BoomScapeTestServer.exe build/win-x86/
cp target/BoomScapeTestServer.jar build/win-x86/
...
echo BoomScapeTestServer.exe 32bit sha256sum
sha256sum build/win-x86/BoomScapeTestServer.exe

dumpbin //HEADERS build/win-x86/BoomScapeTestServer.exe
