...
This repository holds the launcher for the [BoomPSTestServer client](https://github.com/runelite/runelite).
...
BoomPSTestServer is [licensed under the BSD 2-clause license](https://github.com/runelite/launcher/blob/master/LICENSE).
