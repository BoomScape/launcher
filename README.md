...
This repository holds the launcher for the [BoomScapeTestServer client](https://github.com/runelite/runelite).
...
BoomScapeTestServer is [licensed under the BSD 2-clause license](https://github.com/runelite/launcher/blob/master/LICENSE).
