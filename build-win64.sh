...
cp native/build-x64/src/Release/BoomPS.exe build/win-x64/
cp build/libs/BoomPS.jar build/win-x64/
...
echo BoomPS.exe 64bit sha256sum
sha256sum build/win-x64/BoomPS.exe

dumpbin //HEADERS build/win-x64/BoomPS.exe
