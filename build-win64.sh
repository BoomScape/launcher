...
cp native/build-x64/src/Release/BoomScapeTestServer.exe build/win-x64/
cp target/BoomScapeTestServer.jar build/win-x64/
...
echo BoomScapeTestServer.exe 64bit sha256sum
sha256sum build/win-x64/BoomScapeTestServer.exe

dumpbin //HEADERS build/win-x64/BoomScapeTestServer.exe
