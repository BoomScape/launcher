...
cp native/build-x64/src/Release/BoomPSTestServer.exe build/win-x64/
cp build/libs/BoomPSTestServer.jar build/win-x64/
...
echo BoomPSTestServer.exe 64bit sha256sum
sha256sum build/win-x64/BoomPSTestServer.exe

dumpbin //HEADERS build/win-x64/BoomPSTestServer.exe
